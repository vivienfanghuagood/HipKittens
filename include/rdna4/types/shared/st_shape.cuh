 ...
 * changes where the bytes land. rdna4's `st` descends from the cdna3 design,
 ...
 *
 * So the member below is a *description* of what rdna4's shared tiles already
 ...
 * rdna4 the one shape its tiles actually use lets those tests be ported
...
struct st_16x16 {
    ...
    /// The width of one thread's global<->shared transfer. rdna4 moves shared
